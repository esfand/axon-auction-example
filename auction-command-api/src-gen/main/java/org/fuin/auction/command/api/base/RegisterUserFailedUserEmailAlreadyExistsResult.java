 ...
 */
public final class RegisterUserFailedUserEmailAlreadyExistsResult extends AbstractOperationResult {
	 ...
	 * Default constructor.
	 */
	public RegisterUserFailedUserEmailAlreadyExistsResult() {
		super(CODE, ERROR, "The email address is already registered by another user");
	}
