 ...
 */
public final class CreateCategoryFailedNameAlreadyExistResult extends AbstractOperationResult {
	 ...
	 * Default constructor.
	 */
	public CreateCategoryFailedNameAlreadyExistResult() {
		super(CODE, ERROR, "The category name already exists");
	}
