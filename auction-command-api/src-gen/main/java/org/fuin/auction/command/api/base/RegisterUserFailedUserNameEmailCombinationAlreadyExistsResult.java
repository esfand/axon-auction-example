 ...
 */
public final class RegisterUserFailedUserNameEmailCombinationAlreadyExistsResult extends
	 ...
	 * Default constructor.
	 */
	public RegisterUserFailedUserNameEmailCombinationAlreadyExistsResult() {
		super(CODE, ERROR, "The combination of user name and email is already registered");
	}
